 ...
 *
 *   The override reads ghost_underlying instead. The formula
...
contract QIEVaultHarness is QIEVault {
    ...
    /// The spec bounds this via `require vault.ghost_underlying() <= X`.
    ...
    /**
     * @notice Returns ghost_underlying + 1.
     * @dev    Identical formula to production. Only the data source changes:
     *         ghost_underlying instead of IERC20(asset()).balanceOf().
     */
