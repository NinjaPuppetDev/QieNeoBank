...
contract QIEVault is ERC4626, Ownable2Step, ReentrancyGuard {
    ...
    // ── Deposit / Withdraw ─────────────────────────────────────
    function deposit(uint256 assets, address receiver) public override logInternal38(receiver)nonReentrant returns (uint256 shares) {
    ...
    function redeem(uint256 shares, address receiver, address owner_)
        public
        override
        logInternal37(owner_)nonReentrant
        returns (uint256 assets)
    {
        if (shares == 0) revert ZeroAmount();
        return super.redeem(shares, receiver, owner_);
    }modifier logInternal37(address owner_) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250000, 1037618708517) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00250005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00256002, owner_) } _; }
