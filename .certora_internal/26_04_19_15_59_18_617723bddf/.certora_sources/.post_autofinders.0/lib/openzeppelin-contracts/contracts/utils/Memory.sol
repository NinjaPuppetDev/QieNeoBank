...
library Memory {
    ...
    function getFreeMemoryPointer() internal pure returns (Pointer ptr) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d0000, 1037618708573) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005d0004, 0) }
     ...
     **/
    function unsafeSetFreeMemoryPointer(Pointer ptr) internal pure {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005e0000, 1037618708574) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005e0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005e0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff005e6000, ptr) }
        assembly ("memory-safe") {
            mstore(0x40, ptr)
        }
    }
    ...
    function forward(Pointer ptr, uint256 offset) internal pure returns (Pointer) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00600000, 1037618708576) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00600001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00600005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00606001, offset) }
        return Pointer.wrap(bytes32(uint256(Pointer.unwrap(ptr)) + offset));
    }

    /// @dev Equality comparator for memory pointers.
    function equal(Pointer ptr1, Pointer ptr2) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00610000, 1037618708577) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00610001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00610005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00616001, ptr2) }
    ...
    function length(Slice self) internal pure returns (uint256 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620000, 1037618708578) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00626000, self) }
        assembly ("memory-safe") {
            result := shr(128, self)
        }
    }
    ...
    function slice(Slice self, uint256 offset, uint256 len) internal pure returns (Slice) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640000, 1037618708580) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00646002, len) }
    ...
    function toBytes(Slice self) internal pure returns (bytes memory result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00660000, 1037618708582) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00660001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00660005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00666000, self) }
    ...
    function equal(Slice a, Slice b) internal pure returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670000, 1037618708583) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00676001, b) }
    ...
    function isReserved(Slice self) internal pure returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680000, 1037618708584) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00686000, self) }
     ...
     * correct.
     */
    function _asSlice(uint256 len, Memory.Pointer ptr) private pure returns (Slice result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00690000, 1037618708585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00690001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00690005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00696001, ptr) }
        assembly ("memory-safe") {
