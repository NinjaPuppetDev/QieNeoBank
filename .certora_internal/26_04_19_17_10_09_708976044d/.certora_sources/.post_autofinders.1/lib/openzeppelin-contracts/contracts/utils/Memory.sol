...
library Memory {
    ...
    function getFreeMemoryPointer() internal pure returns (Pointer ptr) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01380000, 1037618708792) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01380001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01380004, 0) }
    ...
    function forward(Pointer ptr, uint256 offset) internal pure returns (Pointer) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013b0000, 1037618708795) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013b0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013b0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013b6001, offset) }
        return Pointer.wrap(bytes32(uint256(Pointer.unwrap(ptr)) + offset));
    }

    /// @dev Equality comparator for memory pointers.
    function equal(Pointer ptr1, Pointer ptr2) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013c0000, 1037618708796) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013c0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013c0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013c6001, ptr2) }
    ...
    function asSlice(bytes memory self) internal pure returns (Slice result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013a0000, 1037618708794) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013a0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013a0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013a6000, self) }
        assembly ("memory-safe") {
    ...
    function slice(Slice self, uint256 offset) internal pure returns (Slice) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013e0000, 1037618708798) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013e0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013e6001, offset) }
    ...
    function slice(Slice self, uint256 offset, uint256 len) internal pure returns (Slice) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013f0000, 1037618708799) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013f0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013f0005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff013f6002, len) }
     ...
     */
    function load(Slice self, uint256 offset) internal pure returns (bytes32 value) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01400000, 1037618708800) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01400001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01400005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01406001, offset) }
    ...
    function toBytes(Slice self) internal pure returns (bytes memory result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01410000, 1037618708801) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01410001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01410005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01416000, self) }
    ...
    function isReserved(Slice self) internal pure returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430000, 1037618708803) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01430005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01436000, self) }
     ...
     * correct.
     */
    function _asSlice(uint256 len, Memory.Pointer ptr) private pure returns (Slice result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01440000, 1037618708804) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01440001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01440005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01446001, ptr) }
        assembly ("memory-safe") {
    ...
    function _pointer(Slice self) private pure returns (Memory.Pointer result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01450000, 1037618708805) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01450001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01450005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01456000, self) }
        assembly ("memory-safe") {
