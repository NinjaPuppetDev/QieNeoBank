...
library Memory {
    ...
    function getFreeMemoryPointer() internal pure returns (Pointer ptr) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620000, 1037618708578) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00620004, 0) }
    ...
    function asSlice(bytes memory self) internal pure returns (Slice result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640000, 1037618708580) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00640005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00646000, self) }
        assembly ("memory-safe") {
    ...
    function length(Slice self) internal pure returns (uint256 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670000, 1037618708583) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00670005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00676000, self) }
        assembly ("memory-safe") {
            result := shr(128, self)
        }
    }
    ...
    function slice(Slice self, uint256 offset) internal pure returns (Slice) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680000, 1037618708584) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00680005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00686001, offset) }
    ...
    function equal(Slice a, Slice b) internal pure returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006c0000, 1037618708588) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006c0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006c0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006c6001, b) }
    ...
    function isReserved(Slice self) internal pure returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006d0000, 1037618708589) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006d0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006d0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006d6000, self) }
     ...
     * correct.
     */
    function _asSlice(uint256 len, Memory.Pointer ptr) private pure returns (Slice result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e0000, 1037618708590) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e6001, ptr) }
        assembly ("memory-safe") {
    ...
    function _pointer(Slice self) private pure returns (Memory.Pointer result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f0000, 1037618708591) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f6000, self) }
        assembly ("memory-safe") {
